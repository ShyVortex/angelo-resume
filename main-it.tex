...
\begin{document}
	...
	\begin{flushleft}  % Rplace here with your name (and identity if required)
		...
		\hspace{0.2cm} \fontsize{10pt}{10pt}{(Settembre 2026)}
	...
	\sectionBlock{
		...
		{\href{https://2dconsulting.it/}{2D Consulting}}{Italia, Remoto}{11/2025 - 03/2026 | 06/2026 - 08/2026}
		{Realizzazione di progetti software per conto di due clienti:}
		\itemListStart
		\myItem{Progettazione e sviluppo di un portale web completo con gestione di ruoli e sicurezza per la fruizione di servizi aziendali ministeriali ottenuti tramite la piattaforma PDND Interoperabilità di PagoPA per conto di SACA - Servizi Ambientali Centro Abruzzo. Il backend è realizzato in NestJS e il frontend in Angular.}
		\myItem{Progettazione e sviluppo di un'applicazione mobile in collaborazione con il Consorzio di Bonifica per l'Abruzzo Interno - Bacino Aterno e Sagittario, utilizzando il framework Angular con il linguaggio TypeScript.}
		\itemListEnd
		\vspace{0.5em}
