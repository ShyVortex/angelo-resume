...
\begin{document}
	...
	\begin{flushleft}  % Rplace here with your name (and identity if required)
		...
		\hspace{0.2cm} \fontsize{10pt}{10pt}{(Luglio 2026)}
	...
	\sectionBlock{
		...
		\item \textit{Sito web: } {\url{https://angelotrotta.pages.dev/}}
	...
	\sectionBlock{
		...
		{\href{https://www.reportaziende.it/emmegi-tech-di-mimmo-petrangelo\_is\_it20686184}{Emmegi Tech S.r.l.}}{Italia, Remoto}{06/2026 - In corso}
		{Progettazione e sviluppo di un portale web completo con gestione di ruoli e sicurezza per la fruizione di servizi aziendali ministeriali ottenuti tramite la piattaforma PDND Interoperabilità di PagoPA per conto di SACA - Servizi Ambientali Centro Abruzzo. Il backend è realizzato in NestJS e il frontend in Angular.}
		\vspace{0.5em}
	
		\internHeading
		{Frontend Developer}
		{\href{https://duedformazione.it/}{2D Formazione}}{Italia, Remoto}{11/2025 - 03/2026}
		{Progettazione e sviluppo di un'applicazione mobile in collaborazione con il Consorzio di Bonifica per l'Abruzzo Interno - Bacino Aterno e Sagittario, utilizzando il framework Angular con il linguaggio TypeScript.}
		\vspace{0.5em}
		...
		\internHeading
		{WordPress Developer}
		{\href{https://www.business121.it/}{Business 121}}{Italia, Remoto}{12/2025 - 02/2026}
		{Manutenzione e sviluppo sito aziendale WordPress/WooCommerce con implementazione 
		di nuove funzionalità.}
		\itemListStart
		\myItem{Riscrittura codice footer e riorganizzazione home page}
		\myItem{Funzionalità custom in PHP (hooks, filters, actions)}
		\myItem{Personalizzazione checkout e-commerce con validazione campi italiani}
		\myItem{Integrazione e customizzazione plugin (Elementor, ShopEngine, WooCommerce)}
		\myItem{Debugging frontend/backend con JavaScript/jQuery e PHP}
		\myItem{Gestione CSS personalizzato e responsive design}
		...
		{\href{https://store.steampowered.com/curator/37072886-Devils-in-the-Detail/}{Devils In The Detail}}{Italia, Remoto}{01/2021 - 01/2022}
		...
		{Contribuito al controllo qualità del gioco indie horror in prima persona \href{https://store.steampowered.com/app/1394830/LOCIS/}{LOCIS}, pubblicato su Steam.} \vspace{0.15em}
		\itemListStart
	...
	\sectionBlock{
		...
		\myItem{Internet of Things e Principi di Automazione}
		\myItem{Laboratorio di Fisica per l'Informatica}
		\myItem{Software Analytics for Cybersecurity}
		\myItem{Crittografia}
		\myItem{Network and Industrial Security}
		\myItem{Privacy e sicurezza delle informazioni}
		\itemListEnd
		\vspace{1em}
		
		\eduHeading
		{\large \href{https://github.com/ShyVortex/angelo-resume/blob/main/Certs/CGMCourse.pdf}{Corso TypeScript, React e Next.js con l’AI}}{12 Giugno 2026}
		{Lavoropiù S.p.A.}{} \vspace{0.25em}
		\nbItListStart
		\myItem{Ente finanziatore: Forma.Temp}
		\myItem{Apl promotrice: Lavoropiù S.p.A.}
		\myItem{Ente attuatore: Forpiù sede Bologna}
		\myItem{Codice progetto: 021PROTD2623136}
		\myItem{Tipologia: Professionale}
		\myItem{Durata: 240 ore}
		\myItem{Docente: Antonino Melluso}
		\myItem{Modalità: Da remoto} \vspace{0.5em}
		\newline \indent Argomenti:
		\itemListEnd
		\itemListStart
		\myItem{HTML e CSS}
		\myItem{JavaScript moderno}
		\myItem{TypeScript}
		\myItem{React per interfacce moderne}
		\myItem{Next.js: applicazioni production-like}
		\myItem{Back-end simulato con json-server e json-server-auth}
		\myItem{Git e lavoro in team}
		\myItem{AI applicata allo sviluppo}
		\itemListEnd
		\nbItListStart
		\myItem{Link alla repository del corso: \url{https://github.com/ShyVortex/esercizi-cgm}}
		\itemListEnd
		\vspace{0.65em}
		
		\eduHeading
		{\large \href{https://github.com/ShyVortex/angelo-resume/blob/main/Certs/SecGen.pdf}{Formazione Generale Lavoratori}}{6 Maggio 2026}
		{ForIT Società Cooperativa a R.L.}{} \vspace{0.25em}
		\nbItListStart
		\myItem{Codice progetto: 021PROTD2623136}
		\myItem{Durata: 8 ore}
		\myItem{Modalità: Da remoto} \vspace{0.5em}
		...
		\itemListEnd
		\itemListStart
		\myItem{Salute e sicurezza generale}
		\myItem{Diritti e Doveri dei lavoratori in somministrazione}
		\itemListEnd
		\vspace{0.65em}
	...
	\sectionBlock{
		...
		{Università degli Studi del Molise, Pesche (IS)} {12/2025 - 01/2026}
		{Sviluppo di una pipeline Python modulare per la classificazione automatizzata di recensioni di app mobili in categorie di Ingegneria dei Requisiti (Bug, Feature, Usability, ecc.).
			Il sistema integra LLM locali (DeepSeek-R1) tramite Ollama, implementando strategie di prompt engineering (Zero-Shot, Few-Shot, Chain-of-Thought) e logiche di "smart resume" per l'efficienza computazionale. Progettato per garantire la riproducibilità scientifica, include meccanismi di parsing robusto (Regex/JSON) e gestione ottimizzata delle risorse hardware (CPU/GPU offloading) per l'elaborazione massiva di dataset testuali.}
		{Link al progetto: \url{https://github.com/ShyVortex/neural-clap}}\vspace{0.65em}
	...
	\sectionBlock{
		...
		\eduHeading
		{\large \href{https://github.com/ShyVortex/angelo-resume/blob/main/Certs/RustCert.pdf}{Getting Started with Rust (LFEL1002)}}{14 Dicembre 2024}
	...
	\flushleft{"Autorizzo il trattamento dei miei dati personali presenti nel curriculum vitae ai sensi del Regolamento UE 2016/679 (GDPR)."}
