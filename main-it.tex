...
\begin{document}
	...
	\begin{flushleft}  % Rplace here with your name (and identity if required)
		...
		\hspace{0.2cm} \fontsize{10pt}{10pt}{(Giugno 2026)}
	...
	\newpage \sectionBlock{
		...
		\eduHeading
		{\large \href{https://cgmconsulting.it/corsi/typescript-react-nextjs-ai-online-248-ore}{Formazione Generale Lavoratori}}{6 Maggio 2026}
		{CGM Consulting S.r.l.}{} \vspace{0.25em}
		\nbItListStart
		\myItem{Ente finanziatore: Forma.Temp}
		\myItem{Apl promotrice: Lavoropiù S.p.A.}
